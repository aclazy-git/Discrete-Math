[
    //Math-note.css
    //1.Theorem-thm
    {trigger: "thm", replacement: ">[!theorem] 定理 $0\n>$1\n>^thm", options: "tw"},
    //2. Axiom-axm
    {trigger: "axm", replacement: ">[!axiom] 公理 $0\n>$1\n>^axm", options: "tw"},
    //3. Definition-def
    {trigger: "def", replacement: ">[!definition] 定义 $0\n>$1\n>^def", options: "tw"},
    //4. Proposition-prop
    {trigger: "prop", replacement: ">[!proposition] 命题 $0\n>$1\n>^prop", options: "tw"},
    //5. Instance-ins
    {trigger: "ins", replacement: ">[!instance] 例 $0\n>$1\n>^ins", options: "tw"},
	{trigger: ">ins", replacement: ">> [!ins] 例", options: "tw"},
    //6. Annotation-ann
    {trigger: "ann", replacement: ">[!annotation]- 注 $0\n>$1\n>^ann", options: "tw"},
	{trigger: ">ann", replacement: ">>[!annotation]- 注", options: "tw"},
    //7. Proof-prf
    {trigger: "prf", replacement: ">[!proof]- 证明 $0\n>$1\n>^prf", options: "tw"},
	{trigger: ">prf", replacement: ">> [!proof]- 证明", options: "tw"},
	//8. Solution-sol
    {trigger: "sol", replacement: ">[!solution]- 解 $0\n>$1\n>^sol", options: "tw"},
	{trigger: ">sol", replacement: ">>[!solution]- 解 $0", options: "tw"},
	// 9. Point-poi
	{trigger: "poi", replacement: ">[!point] 观点 $0\n>$1\n>^poi", options: "tw"},
	// 10. Question-que
	...
	//table
	{trigger: "tab", replacement: ">[!table] 表 $0 ^tab-$0", options: "tw"},
	...
	{trigger: "limm", replacement: "\\lim", options: "mA"},
    {trigger: "limt", replacement: "\\lim_{ ${0:n} \\to ${1:\\infty} } $2", options: "mA"},
